...
import { Plus, Check, Target, Repeat, Clock, Filter, Calendar, AlertTriangle, Zap, BarChart2, Info } from 'lucide-react';
...
export const Tasks: React.FC = () => {
  ...
  const [newTask, setNewTask] = useState<Partial<Task>>({ 
      type: 'Habit', 
      category: 'Personal',
      startDate: getRealTime().toISOString() // Default to real today
  });
  ...
  const handleCreate = (e: React.FormEvent) => {
    ...
    // Use Real Time for creation timestamp
  ...
  // Helper to find missed dates in the last 7 days relative to REAL TIME
